...
name = os.path.basename(out_suffix)
...
fig2_gc = read2_GC_df.plot()
plt.ylim(-0.1, 0.6)
plt.xlabel('position')
plt.ylabel('percent')
plt.title(f'{name} read2')
plt.legend(loc='upper right')
fig2_gc.figure.savefig(f'{out_suffix}.read2.GC.png', dpi=600)
