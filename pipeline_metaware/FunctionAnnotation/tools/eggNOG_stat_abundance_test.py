...
def main(args):
    ...
    ####### 处理_class（level1）
    class_df = merge_df.loc[:, ['Query_id', 'Functional_Category'] + samples]
    ...
    class_split.drop_duplicates(subset=['Query_id', 'Functional_Category'], inplace=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--eggNOG_anno', help='基因-kegg功能注释结果(Unigenes.blast.m8.filter.anno.xls)')
