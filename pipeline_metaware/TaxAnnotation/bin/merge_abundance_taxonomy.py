...
def main(args):
    ...
    merge_df = pd.merge(tax_df, abun_df, on='gene', how='outer').fillna('k__Others;p__Others;c__Others;o__Others;f__Others;g__Others;s__Others')
    ...
    for _class in class_info:
        ...
        # 复现诺禾结果中, 对于Others的判断为, 该层级的为nclass或者others的归为Others
        # 核心过程
